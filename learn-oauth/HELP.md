...
* The original package name 'com.kim.learn-oauth' is invalid and this project uses 'com.kim.learnoauth' instead.
...
* [OAuth2 Client](https://docs.spring.io/spring-boot/docs/3.2.0-M1/reference/htmlsinge/index.html#web.security.oauth2.client)
